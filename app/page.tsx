      ...
      <div className="overflow-hidden">
        {/* Hero Section */}
          ...
          >
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center pt-12 sm:pt-16 lg:pt-20 pb-0 backdrop-blur-lg bg-white/10 border border-white/5 rounded-2xl shadow-2xl">
              <div
