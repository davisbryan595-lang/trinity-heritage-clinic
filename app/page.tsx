      ...
      <div className="overflow-hidden">
        {/* Hero Section */}
          ...
          >
            ...
            <div className="w-full max-w-3xl mx-auto px-3 xs:px-4 sm:px-5 md:px-6 lg:px-8 relative z-10 text-center pt-2 xs:pt-2 sm:pt-3 md:pt-4 lg:pt-5 pb-3 xs:pb-3 sm:pb-4 md:pb-6 lg:pb-8 backdrop-blur-lg bg-white border border-white/5 rounded-xl xs:rounded-2xl shadow-2xl -mb-12 xs:-mb-14 sm:-mb-20 md:-mb-24 lg:-mb-32" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)' }}>
              <div
              ...
              >
                ...
                <div className="mb-4 xs:mb-4 sm:mb-5 md:mb-6 lg:mb-8">
                  <h1 className="font-serif text-sm xs:text-base sm:text-lg md:text-2xl lg:text-4xl xl:text-5xl font-bold leading-tight drop-shadow-lg mb-2 xs:mb-2 sm:mb-3 text-center px-1 whitespace-nowrap">
