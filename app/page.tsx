      ...
      <div className="overflow-hidden">
        {/* Hero Section */}
          ...
          >
            ...
            <div className="max-w-3xl mx-auto px-2 sm:px-4 relative z-10 text-center backdrop-blur-lg rounded-4xl py-12 sm:py-16 lg:py-20 px-4 sm:px-8 lg:px-12 bg-white/5 border border-white/15" style={{
