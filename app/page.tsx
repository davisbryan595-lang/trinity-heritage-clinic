      ...
      <div className="overflow-hidden">
        {/* Hero Section */}
          ...
          >
            ...
            <div className="max-w-4xl mx-auto px-3 sm:px-5 lg:px-6 relative z-10 text-center py-6 sm:py-9 lg:py-12 backdrop-blur-lg bg-white/10 border border-white/5 rounded-2xl shadow-2xl -mb-20 sm:-mb-24 lg:-mb-32">
              <div
