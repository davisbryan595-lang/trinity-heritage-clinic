            ...
            <div className="flex justify-between items-center h-20 sm:h-24 lg:h-32 py-2 sm:py-3 lg:py-4">
              ...
              >
                <div className="relative w-90 h-36 sm:w-[468px] sm:h-45 lg:w-[576px] lg:h-72">
                  ...
                  <div className="absolute top-[58%] -translate-y-1/2 left-1/2 -translate-x-[40%] z-10 px-3 sm:px-4 py-1.5 sm:py-2 rounded-md bg-white/70 backdrop-blur-sm border border-primary/30 shadow-md">
