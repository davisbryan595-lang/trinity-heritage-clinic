            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
              ...
              >
                ...
                <div className="mb-4 sm:mb-6 lg:mb-8 flex flex-col items-center">
                  <h1 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight drop-shadow-lg mb-2 sm:mb-3 text-center max-w-3xl">
                  ...
                  <h2 className="font-serif text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold drop-shadow-lg max-w-xl px-2" style={{ color: '#6b3fa0' }}>
